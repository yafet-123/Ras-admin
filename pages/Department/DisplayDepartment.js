...
export async function getServerSideProps(context) {
	...
	const data = await authaxios.get(`${api}/labdepartment/`)
  	return {
    	props: {
    		labdepartment:data.data,
    	}, // will be passed to the page component as props
  	}
}

export default function Displaymeasurement({labdepartment}) {
    ...
    const [remark, setremark] = useState("")
  	...
  	const handleupdate = async (e)=>{
      	e.preventDefault()
      	await authaxios.patch(`${api}/labdepartment/${id}`,{
      		name:name,
